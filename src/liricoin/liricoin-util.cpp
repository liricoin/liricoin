...
int main(int argc, char* argv[])
{
    ...
    mc_LiricoinParams* params;
    mc_LiricoinParams* paramsOld;
...
//                    err=params->Create(mc_gState->m_Params->m_Arguments[1],version);
                ...
                { 
                    ...
                    printf("You can edit it in %s before running liricoind for the first time.\n\n",fileName);
                    printf("To generate blockchain please run \"liricoind %s -daemon\".\n",params->Name());
                }                
                else
                {
        ...
        if(strcmp(mc_gState->m_Params->Command(),"clone") == 0)
        {
            ...
            {
                params=new mc_LiricoinParams;
                paramsOld=new mc_LiricoinParams;
...
*/        
    ...
    if(err == MC_ERR_OPERATION_NOT_SUPPORTED)
    {
        ...
        printf("Usage:\n");
        printf("  liricoin-util create <blockchain-name>  ( <protocol-version> = %d ) [options]        Creates new liricoin configuration file %s with default parameters\n",
        ...
        printf("  liricoin-util clone <old-blockchain-name> <new-blockchain-name> [options]               Creates new liricoin configuration file %s copying parameters\n",fileName);
