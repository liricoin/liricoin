...
#ifndef LIRICOIN_STATE_H
#define	LIRICOIN_STATE_H

#include "utils/define.h"
#include "chainparams/params.h"
#include "protocol/liricoinscript.h"
...
{    
    ...
    mc_Params               *m_Params;
    mc_LiricoinParams     *m_NetworkParams;
    ...
    void  InitDefaults()
    {
        ...
        m_NetworkParams=new mc_LiricoinParams;
        m_Permissions=NULL;
        m_Assets=NULL;
