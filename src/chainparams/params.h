...
#ifndef LIRICOINPARAMS_H
#define	LIRICOINPARAMS_H
...
typedef struct mc_OneLiricoinParam
{    
...
typedef struct mc_LiricoinParams
{    
    char *m_lpData;
    mc_MapStringIndex *m_lpIndex;
    mc_OneLiricoinParam *m_lpParams;
    int *m_lpCoord;
    int m_Status;
    int m_Size;
    int m_Count;
    int m_IsProtocolLiriCoin;
    int m_ProtocolVersion;
    ...
    int Clone(const char *name,mc_LiricoinParams *source);
