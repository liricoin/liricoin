...
#ifndef LIRICOINPARAMLIST_H
#define LIRICOINPARAMLIST_H

static const mc_OneLiricoinParam LiricoinParamArray[] =
{
    { "chainprotocol"                          , "chain-protocol"                          ,
                   ...
                   "Chain protocol: liricoin (permissions, native assets) or bitcoin"},
...
*/                   
    ...
    { "chainname"                              , "chain-name"                              ,
                   ...
                   "protocolversion","",
                   "Chain name, used as first argument for liricoind and liricoin-cli."},                   
